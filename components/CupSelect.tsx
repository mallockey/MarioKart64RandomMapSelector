...
const CupSelect = ({
  ...
  const buttonStyle = isSelected
    ? "bg-slate-300 mt-2 mb-2 w-32 p-2 md:w-72 md:h-36  text-3xl text-purple-500 font-extrabold flex flex-col items-center justify-center uppercase ml-4 mr-4 border-black  border-4 cursor-pointer"
